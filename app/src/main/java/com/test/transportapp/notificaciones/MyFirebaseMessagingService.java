...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    private void showNotification(Map<String,String> data){
        ...
        notificationBuilder.setSmallIcon(R.drawable.ic_sms_black_24dp)
                .setColor(rgb(255,140,0)).setContentTitle(title)
                .setContentText(body).setAutoCancel(true).setVibrate(new long[]{0,1000,500,100})
                .setSound(defaultSoundUri).setContentIntent(pendingIntent)
                .setContentInfo("Info"); // se pueden enviar varias variables
